...
#define GSM_DTR1_GPIO                   IOPORT_CREATE_PIN(PORTF, 0)
#define GSM_DCD1_GPIO                   IOPORT_CREATE_PIN(PORTF, 1)
...
#define GSM_RTS1_GPIO                   IOPORT_CREATE_PIN(PORTF, 6)
#define GSM_CTS1_DRV_GPIO               IOPORT_CREATE_PIN(PORTF, 7)
...
#define GSM_RTS1						GSM_RTS1_GPIO
#define GSM_CTS1_DRV					GSM_CTS1_DRV_GPIO
